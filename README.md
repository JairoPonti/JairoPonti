...
Soy Jairo Marcelo Ponti, un desarrollador Web Full Stack con experiencia en ecommerce.
En Argentina trabajé desarrollando y manteniendo páginas de marcas como "Portsaid", "Desiderata", "Cuesta Blanca" y "Bremen Tools" entre otras, así como también para "La Espumería" de Uruguay e "ICB" de Chile.
Asímismo puedo mencionar otras experiencias trabajando como freelancer para "Mpower" de México.
Actualmente me encuentro desepeñando tareas para la empresa Valtech, en el equipo dedicado a la marca Arcor, desarrollando y manteninendo Custom apps para su página "Tokin Tienda". Entre mis skills les menciono que vengo programando con Javascript en complemento con Typescript,y utilizando React, jQuery, HTML, CSS, ajax y Postman entre otras herramaientas. Siempre me encuentro dispuesto a adquirir nuevas competencias técnicas y habilidades para la comunicación y el trabajo en equipo. Soy pro comunicación en cualquier equipo de trabajo y lo considero fundamental entre los devs, QA's y la totalidad de piezas que conforman al team.
---
